...
local Settings = {
    ...
    CustomNameTag = "",
    ShowNameTag = false,
    CustomStatusText = "https://discord.gg/h7CjEy3qQY",
    ShowStatusText = true,
        ...
        if isValid then
            ...
            if keyType == "DEVELOPMENT" then
                ...
                task.spawn(function()
                    ...
                    CreateNotification("ANTC HUB", "✅ Name tag applied: Owners ANTC HUB", 3, Color3.fromRGB(0, 255, 150))
                end)
...
function IsKeyValid(key)
    local DeveloperKeys = {
        ...
        ["ANTC-HUB-PTR"] = {tier = "PARTNER", isLifetime = true, dev = "Partner ANTC HUB"},
        ["ANTC-STAFF-KEY"] = {tier = "STAFF", isLifetime = true, dev = "Staff ANTC HUB"},
        ["ANTC-HUB-STAFF"] = {tier = "STAFF", isLifetime = true, dev = "Staff ANTC HUB"}
    }
    ...
    if key == "FREE-PREMIUM-1DAY" then
        ...
        if FreePremiumUsed[userId] then
            ...
            if timeDiff < 86400 then
                ...
                return false, "BELI DONG MAU GRATIS MULU LAWAK KAU DEK DEK 😹😹😹 (Cooldown: " .. hoursLeft .. " hours)", nil
            end
        end
...
function ActivateSafeZone()
    ...
    Settings.SafeZoneOriginalPos = hrp.CFrame
    ...
    SafeZonePlatform.Position = Vector3.new(0, 996, 0)
    ...
    CreateNotification("ANTC HUB", "Safe Zone activated! Platform created at Y=1000", 4, Color3.fromRGB(0, 255, 150))
    SendDeveloperWebhook("🛡️ Activated Safe Zone")
end
...
function DeactivateSafeZone()
    ...
    if Settings.SafeZoneOriginalPos then
        local char = Player.Character
        if char and char:FindFirstChild("HumanoidRootPart") then
            char.HumanoidRootPart.CFrame = Settings.SafeZoneOriginalPos
        end
        Settings.SafeZoneOriginalPos = nil
    end
    
    CreateNotification("ANTC HUB", "Safe Zone deactivated", 3, Color3.fromRGB(255, 150, 50))
    SendDeveloperWebhook("🛡️ Deactivated Safe Zone")
end
...
function CreateSpectateExitButton()
    ...
    ButtonContainer.Position = UDim2.new(0.5, -295, 0, 20)
...
function CreateViewAllKeysUI()
    ...
    local allKeys = {
        {name = "DEVELOPER", keys = {"ANTC-DEVELOPER-MASTER-KEY", "APIS-DEVELOPER-MASTER-KEY", "ANTC-DEVELOPER-2025", "APIS-DEVELOPER-2025"}, tier = 3, color = Color3.fromRGB(0, 255, 150), tag = "Owners ANTC HUB"},
...
function CreateStatusTextEditor()
    ...
    StatusBox.Text = Settings.CustomStatusText or "https://discord.gg/h7CjEy3qQY"
...
🔗 Discord Server: https://discord.gg/h7CjEy3qQY
...
function CreateMainGUI()
    ...
    if SettingsTab then
        ...
        CreateButton(SettingsTab, "Copy Discord Server", "DC", function()
            setclipboard("https://discord.gg/h7CjEy3qQY")
