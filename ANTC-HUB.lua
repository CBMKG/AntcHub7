...
local function CreateKeySystem()
    ...
    task.spawn(function()
        while GetKeyBtn and GetKeyBtn.Parent do
            local pulseTween = TweenService:Create(GetKeyBtn, TweenInfo.new(0.8, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut, -1, true), {
    ...
    GetKeyBtn.MouseButton1Click:Connect(function()
        ...
        local spinTween = TweenService:Create(GetKeyBtn, TweenInfo.new(1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut, 5), {
            Rotation = 360
        })
        spinTween:Play()
